...
Checkbox c4=new Checkbox("Post Graduate",false);
	c4.setBounds(250,400,200,50);
	c4.setBackground(Color.decode("#f5ffe4"));
f.add(c4);
Label lgen=new Label("Gender");
	lgen.setBounds(40,470,200,50);
	lgen.setBackground(Color.decode("#fb9214"));
	lgen.setForeground(Color.decode("#3a2c23"));
f.add(lgen);
Checkbox g1=new Checkbox("Male",false);
	g1.setBounds(250,470,200,50);
	g1.setBackground(Color.decode("#f5ffe4"));
f.add(g1);
Checkbox g2=new Checkbox("Female",false);
	g2.setBounds(250,520,200,50);
	g2.setBackground(Color.decode("#f5ffe4"));
f.add(g2);
Checkbox g3=new Checkbox("Others",false);
	g3.setBounds(250,570,200,50);
